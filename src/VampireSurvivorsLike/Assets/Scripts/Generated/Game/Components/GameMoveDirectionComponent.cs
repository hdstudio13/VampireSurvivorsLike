...
public partial class GameEntity {
    ...
    public Gameplay.Features.Movement.MoveDirection moveDirection { get { return (Gameplay.Features.Movement.MoveDirection)GetComponent(GameComponentsLookup.MoveDirection); } }
    ...
    public GameEntity AddMoveDirection(UnityEngine.Vector3 newValue) {
        ...
        var component = (Gameplay.Features.Movement.MoveDirection)CreateComponent(index, typeof(Gameplay.Features.Movement.MoveDirection));
