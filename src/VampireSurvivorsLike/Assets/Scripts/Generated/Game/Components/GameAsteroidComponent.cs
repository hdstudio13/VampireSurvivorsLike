...
public partial class GameEntity {
    ...
    static readonly Gameplay.Features.Asteroids.Asteroid asteroidComponent = new Gameplay.Features.Asteroids.Asteroid();

    public bool isAsteroid {
        get { return HasComponent(GameComponentsLookup.Asteroid); }
        set {
            if (value != isAsteroid) {
