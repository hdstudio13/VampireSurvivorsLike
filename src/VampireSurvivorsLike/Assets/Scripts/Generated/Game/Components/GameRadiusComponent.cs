...
public partial class GameEntity {
    ...
    public Gameplay.Features.EntityCollisions.Radius radius { get { return (Gameplay.Features.EntityCollisions.Radius)GetComponent(GameComponentsLookup.Radius); } }
    ...
    public GameEntity AddRadius(float newValue) {
        ...
        var component = (Gameplay.Features.EntityCollisions.Radius)CreateComponent(index, typeof(Gameplay.Features.EntityCollisions.Radius));
