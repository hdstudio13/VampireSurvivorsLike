...
public partial class GameEntity {
    ...
    public Gameplay.Features.Effects.Target target { get { return (Gameplay.Features.Effects.Target)GetComponent(GameComponentsLookup.Target); } }
    public uint Target { get { return target.Value; } }
    public bool hasTarget { get { return HasComponent(GameComponentsLookup.Target); } }

    public GameEntity AddTarget(uint newValue) {
        var index = GameComponentsLookup.Target;
        var component = (Gameplay.Features.Effects.Target)CreateComponent(index, typeof(Gameplay.Features.Effects.Target));
        component.Value = newValue;
        AddComponent(index, component);
        return this;
    }

    public GameEntity ReplaceTarget(uint newValue) {
        var index = GameComponentsLookup.Target;
        var component = (Gameplay.Features.Effects.Target)CreateComponent(index, typeof(Gameplay.Features.Effects.Target));
        component.Value = newValue;
