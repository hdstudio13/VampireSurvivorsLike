...
public partial class GameEntity {
    ...
    public Gameplay.Features.Effects.Damage damage { get { return (Gameplay.Features.Effects.Damage)GetComponent(GameComponentsLookup.Damage); } }
    ...
    public GameEntity AddDamage(float newValue) {
        ...
        var component = (Gameplay.Features.Effects.Damage)CreateComponent(index, typeof(Gameplay.Features.Effects.Damage));
