...
public partial class GameEntity {
    ...
    public Gameplay.Features.Movement.MoveSpeed moveSpeed { get { return (Gameplay.Features.Movement.MoveSpeed)GetComponent(GameComponentsLookup.MoveSpeed); } }
    ...
    public GameEntity AddMoveSpeed(float newValue) {
        ...
        var component = (Gameplay.Features.Movement.MoveSpeed)CreateComponent(index, typeof(Gameplay.Features.Movement.MoveSpeed));
